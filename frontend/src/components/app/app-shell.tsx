...
import { BarChart3, ClipboardList, Home, LogOut, School, Users } from 'lucide-react';
...
const items = [
  ...
  { to: '/oficinas', label: 'Oficinas', icon: School },
        ...
        <aside className="hidden w-72 shrink-0 flex-col rounded-[28px] border border-slate-200/80 bg-slate-950 px-5 py-6 text-slate-100 shadow-[0_20px_60px_rgba(15,23,42,0.24)] lg:flex">
          ...
          <div className="mt-auto rounded-3xl border border-white/10 bg-white/5 p-4">
            ...
            <Button
              type="button"
              variant="secondary"
              className="mt-4 w-full justify-center bg-white text-slate-950 hover:bg-slate-100"
              onClick={() => {
                logout();
